    ...
    >
      ...
      <div className="max-w-sm mx-auto space-y-6 relative z-10 pt-4 pb-8">
        <div className="text-center">
          <h1 className="text-3xl font-light tracking-wide text-gray-900">Workout Preferences</h1>
          ...
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4">
                <div>
                  <h2 className="text-lg font-light text-gray-900">
                    How often would you like a curated workout? <span className="text-red-500">*</span>
                  </h2>
              ...
              <div className="space-y-4">
                <div>
                  <h2 className="text-lg font-light text-gray-900">
                    How long would you like the workout to be? <span className="text-red-500">*</span>
                  </h2>
