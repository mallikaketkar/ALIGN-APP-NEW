    ...
    >
      ...
      <div className="max-w-sm mx-auto space-y-6 relative z-10 pt-4 pb-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-3xl font-light tracking-wide text-gray-900">My Profile</h1>
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-light text-gray-900">Weight Goals</h2>
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-light text-gray-900">Fitness Goals</h2>
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-light text-gray-900">Workout Preferences</h2>
