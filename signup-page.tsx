              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={`h-14 text-base rounded-xl border-2 ${errors.name ? "border-red-500" : "border-gray-200"} focus:border-gray-900`}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={`h-14 text-base rounded-xl border-2 ${errors.confirmPassword ? "border-red-500" : "border-gray-200"} focus:border-gray-900`}
