...
const getCategoryColor = (category: string) => {
  const colors = {
    nutrition: "from-red-900 to-black",
    training: "from-red-800 to-black",
    recovery: "from-black to-red-950",
    mindset: "from-red-950 to-red-900",
  }
  return colors[category as keyof typeof colors] || "from-gray-900 to-black"
}
    ...
    >
      ...
      <div className="max-w-sm mx-auto space-y-6 relative z-10 pt-4 pb-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <Badge className="bg-gray-900 text-white text-xs px-3 py-1 font-medium">
        ...
        {/* Article Header Card */}
        <Card
          className={`relative overflow-hidden bg-gradient-to-br ${getCategoryColor(article.category)} border-0 shadow-xl rounded-2xl`}
        >
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-gray-100">
                ...
                <Button
                  ...
                  className="w-full bg-gray-900 text-white hover:bg-gray-800 font-bold tracking-wide h-14 text-base rounded-xl shadow-lg"
                >
        ...
        <Card className="bg-white border-0 shadow-sm rounded-2xl">
          <CardContent className="p-6">
            <div className="text-center space-y-3">
              <h3 className="text-lg font-bold text-gray-900">Expert Content</h3>
