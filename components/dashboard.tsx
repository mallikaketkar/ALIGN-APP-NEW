    ...
    >
      ...
      <div className="max-w-sm mx-auto relative z-10 pt-6 pb-8">
        ...
        <div className="space-y-6 px-4">
          ...
          {!hasCompletedCheckin && (
            <Card className="relative overflow-hidden bg-red-600 border-0 shadow-xl rounded-2xl">
              <div
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/90 text-sm font-medium">Optimize your performance</p>
                    </div>
                  </div>
                  ...
                  <Button
                    ...
                    className="w-full bg-white text-red-600 hover:bg-gray-100 font-bold tracking-wide h-14 text-lg rounded-xl shadow-lg"
                  >
                    START
                  </Button>
                </div>
          ...
          {hasCompletedCheckin && (
            <Card className="relative overflow-hidden bg-black border-0 shadow-xl rounded-2xl">
              <div
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-gray-300 text-sm font-medium">Today's performance metrics</p>
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-300 font-medium">Physical</div>
                    </div>
                    <div className="text-center">
                      <Brain className="w-5 h-5 text-gray-300 mx-auto mb-1" />
                      <div className="text-lg font-bold">{readinessScore.mentalReadiness}</div>
                      <div className="text-xs text-gray-300 font-medium">Mental</div>
                    </div>
                    <div className="text-center">
                      <Heart className="w-5 h-5 text-gray-300 mx-auto mb-1" />
                      <div className="text-lg font-bold">{readinessScore.recoveryReadiness}</div>
                      <div className="text-xs text-gray-300 font-medium">Recovery</div>
                    </div>
                  </div>
            ...
            <Card className="relative overflow-hidden bg-black border-0 shadow-xl rounded-2xl">
              ...
              <CardContent className="relative p-0">
                <Button
                  ...
                  variant="ghost"
                  className="w-full h-40 flex flex-col items-center justify-center gap-3 hover:bg-white/10 rounded-2xl text-white"
                >
              ...
              <CardContent className="relative p-0">
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xs text-white/90 font-medium mt-1">Expert insights</div>
                  </div>
                </Button>
              </CardContent>
            </Card>
              ...
              <CardContent className="relative p-0">
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xs text-white/90 font-medium mt-1">Begin training</div>
                  </div>
                </Button>
              </CardContent>
            </Card>
