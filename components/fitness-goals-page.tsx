    ...
    >
      ...
      <div className="max-w-sm mx-auto space-y-6 relative z-10 pt-4 pb-8">
        <div className="text-center">
          <h1 className="text-3xl font-light tracking-wide text-black">Fitness Goals</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <h2 className="text-lg font-light text-black mb-2">
                  Main Goals <span className="text-red-600">*</span>
                </h2>
                <p className="text-xs text-gray-600 mb-4">Select up to 2 goals</p>
                {errors.mainGoals && <p className="text-red-600 text-xs mb-4">{errors.mainGoals}</p>}
              </div>
