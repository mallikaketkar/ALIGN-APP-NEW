    ...
    >
      ...
      <div className="max-w-sm mx-auto space-y-6 relative z-10 pt-4 pb-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-3xl font-light tracking-wide text-black">Exercises</h1>
              ...
              <CardContent className="p-4">
                <div className="space-y-3">
                  <div className="flex items-start justify-between">
                    <h3 className="font-medium text-black text-sm leading-tight flex-1 pr-2">{exercise.name}</h3>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="font-medium text-black">{getMuscleGroupLabel(exercise)}</span>
                    </div>

                    <div className="flex items-center justify-between text-xs">
                      <span className="text-gray-600">Exercise Type:</span>
                      <span className="font-medium text-black">{getExerciseTypeLabel(exercise.type)}</span>
                    </div>
