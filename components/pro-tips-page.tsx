      ...
      >
        ...
        <div className="max-w-sm mx-auto space-y-6 relative z-10 pt-4 pb-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-black">{categoryData?.title}</h1>
            <div className="w-9" />
          </div>

          {/* Category Header */}
          <Card className={`relative overflow-hidden ${categoryData?.color} border-0 shadow-xl rounded-2xl`}>
                  ...
                  <CardContent className="p-0">
                    ...
                    >
                      <div className="w-full space-y-2">
                        ...
                        <h3 className="text-sm font-bold text-black leading-tight break-words whitespace-normal">
                          {article.title}
                        </h3>
    ...
    >
      ...
      <div className="max-w-sm mx-auto space-y-6 relative z-10 pt-4 pb-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-black">Pro Tips</h1>
          <div className="w-9" />
        </div>
          ...
          <CardContent className="relative p-6 text-white">
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-white/90 text-sm font-medium mt-2">Performance optimization content</p>
              </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            {categories.map((category) => {
              ...
              return (
                <Card key={category.id} className={`relative overflow-hidden ${category.color} border-0 shadow-xl rounded-2xl`}>
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-bold text-black px-2">Latest Articles</h3>
