...
export default function DailyReadinessFlow({
  ...
  const getReadinessLevel = (score: number) => {
    if (score >= 80) return { level: "excellent", color: "bg-black", textColor: "text-black" }
      ...
      >
        ...
        <div className="max-w-sm mx-auto space-y-6 relative z-10 pt-4 pb-8">
          ...
          <div className="text-center space-y-2">
            <h1 className="text-3xl font-light tracking-wide text-black">Readiness Score</h1>
          ...
          <Card className="bg-white border-0 shadow-xl rounded-2xl">
            <CardContent className="p-6">
              ...
              <div className="text-center space-y-4 mb-8">
                <div className="relative w-32 h-32 mx-auto">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-3xl font-light text-black">{overallReadiness}</span>
                  </div>
                </div>
                <div>
                  <Badge className="bg-red-600 text-white text-sm px-4 py-1 font-light lowercase tracking-wide">
                    {overallLevel.level}
                  </Badge>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-light lowercase tracking-wide text-black">physical</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="text-lg font-light text-black">{physicalReadiness}</div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-light lowercase tracking-wide text-black">mental</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="text-lg font-light text-black">{mentalReadiness}</div>
                    <div className="h-2 w-16 bg-gray-300 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-red-600 rounded-full transition-all duration-1000"
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-light lowercase tracking-wide text-black">recovery</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="text-lg font-light text-black">{recoveryReadiness}</div>
                    <div className="h-2 w-16 bg-gray-300 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-red-600 rounded-full transition-all duration-1000"
              ...
              <div className="text-center space-y-3">
                <h3 className="text-lg font-light tracking-wide text-black">Protocol</h3>
          ...
          <div className="space-y-3">
            <Button
              ...
              className="w-full bg-red-600 text-white hover:bg-red-700 font-bold tracking-wide h-14 rounded-xl shadow-lg"
            >
            ...
            <Button
              onClick={handleReset}
              className="w-full bg-white border-2 border-black text-black hover:bg-gray-50 font-bold tracking-wide h-14 rounded-xl"
              variant="outline"
            >
      ...
      <div className="max-w-sm mx-auto space-y-6 relative z-10 pt-4 pb-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-center">
            <h1 className="text-3xl font-bold tracking-tight text-black">Daily Check-In</h1>
        ...
        <div className="w-full bg-gray-200 rounded-full h-3 shadow-inner">
          <div
            className="bg-red-600 h-3 rounded-full transition-all duration-500 shadow-sm"
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-black font-light text-base leading-relaxed">{currentQuestion.text}</p>
                </div>
              </div>
                  ...
                  {currentQuestion.options.map((option) => (
                    ...
                    >
                      <RadioGroupItem
                        ...
                        className="border-gray-400 text-red-600"
                      />
                      <Label
        ...
        <div className="flex gap-3">
          {currentQuestionIndex > 0 && (
            <Button
              ...
              variant="outline"
              className="flex-1 bg-transparent border border-black text-black hover:bg-gray-200 font-light tracking-wide h-12 rounded-xl"
            >
              Previous
            </Button>
          )}
          <Button
            ...
            className="flex-1 bg-red-600 text-white hover:bg-red-700 font-bold tracking-wide h-14 text-base disabled:bg-gray-400 disabled:text-gray-600 rounded-xl shadow-lg"
          >
