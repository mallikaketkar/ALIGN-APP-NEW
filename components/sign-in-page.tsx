        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <Button
              ...
              variant="outline"
              className="w-full bg-transparent border-2 border-red-600 text-red-600 hover:bg-red-600 hover:text-white font-bold tracking-wide h-14 text-lg rounded-xl"
            >
              CREATE ACCOUNT
            </Button>
          </div>
