    ...
    >
      ...
      <div className="max-w-sm mx-auto space-y-6 relative z-10 pt-4 pb-8">
        <div className="text-center">
          <h1 className="text-3xl font-light tracking-wide text-gray-900">Activity Level</h1>
          ...
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                {errors.activityLevel && <p className="text-red-500 text-xs mb-4">{errors.activityLevel}</p>}
              </div>
